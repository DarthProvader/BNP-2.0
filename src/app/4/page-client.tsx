          ...
          <div className="paper-bg p-6 sm:p-10 relative shadow-2xl staple overflow-hidden">
            ...
            <div className="doc-header-line">
              ...
              <Link
                ...
                style={{ fontFamily: "var(--font-staatliches), sans-serif" }}
              >
                {(lang === "cs" ? featured.title : featured.titleEn).toUpperCase()}
              </Link>
            </div>
            ...
            <div className="typewriter-text text-sm text-[#1a1a1a] relative z-[4]">
              <ArticleContent
                content={lang === "cs" ? featured.content : featured.contentEn}
          ...
          <div className="flex flex-wrap gap-2">
            {allTags.map((tag) => (
              <span
                ...
                className={`dept-tag cursor-pointer transition-colors ${
                  activeTag === tag
                    ? "text-neutral-200 border-neutral-200 bg-neutral-800"
                    : "text-neutral-400 border-neutral-600 hover:text-neutral-200 hover:border-neutral-400"
                }`}
              >
              ...
              return (
                ...
                >
                  ...
                  <div className="paper-bg p-5 sm:p-6 shadow-lg relative overflow-hidden">
                    ...
                    >
                      {(lang === "cs" ? article.title : article.titleEn).toUpperCase()}
                    </h3>
