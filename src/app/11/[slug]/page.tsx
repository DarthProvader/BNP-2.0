...
export default function ArticleDetailPage({
  ...
  const [lang, setLang] = React.useState<"cz" | "en">("cz");
  ...
  if (!article) {
    return (
      ...
      >
        ...
        <div className="brutal-page min-h-screen flex items-center justify-center">
          <div className="cut-out p-12 text-center relative scanline">
            <h1 className="font-headline text-5xl glitch-text mb-6">404</h1>
            <p className="font-mono text-sm text-[#f0f0f0]/70 mb-8">
              Clanek nenalezen. Mozna ho AI smazala.
            </p>
            <Link
              href="/11"
        ...
        <section className="px-4 sm:px-8 py-8 border-t border-[#f0f0f0]/10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <Link
              ...
              className="font-mono text-xs uppercase tracking-widest text-[#ff2222] harsh-underline"
            >
              &larr; {lang === "cz" ? "Vsechny clanky" : "All articles"}
            </Link>
